...
Live 运维和恢复演练按 [Live Operations And Recovery Runbook](docs/operations/live-runbook.md) 执行。
...
| Operational-ready | 具备可重复 release gate、live smoke gate、recovery drill、runbook、known limitations、observability 和 credential rotation。 | 尚未完成。 |

已知 readiness 缺口包括长期调度、真实 diff enforcement 完整性、fix loop 加固、集中 observability、credential rotation，以及 release 前 operational-ready 检查清单。未满足的项目应在 release notes 的 known limitations 中明确说明。
