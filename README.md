...
已知 readiness 缺口包括长期调度、真实 diff enforcement 完整性、fix loop 加固、集中 observability、credential rotation、完整 live operations runbook，以及 release 前 operational-ready 检查清单。未满足的项目应在 release notes 的 known limitations 中明确说明。
