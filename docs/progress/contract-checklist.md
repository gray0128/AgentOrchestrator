...
| C-API-002 | Internal interface | Agent Adapter | Agent Router, role handlers | Adapter interface, fake adapter, process adapter stdin/stdout tests, routing adapter profile tests, coding CLI wrapper, env secret filtering, planner envelope, plan result, and reviewer verdict tests | Implemented for T-M6-005 |
